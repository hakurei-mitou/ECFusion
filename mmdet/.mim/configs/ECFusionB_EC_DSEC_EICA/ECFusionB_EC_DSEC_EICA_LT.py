...
# randomness=dict(seed=1554879236)
...
assert isinstance(fusion_module['BDC'], bool)
assert isinstance(fusion_module['EICA'], bool)
assert fusion_module['GSTFM'] + fusion_module['CC'] + fusion_module['EF'] \
    + fusion_module['LF'] + fusion_module['BDC'] + fusion_module['EICA']== 1
