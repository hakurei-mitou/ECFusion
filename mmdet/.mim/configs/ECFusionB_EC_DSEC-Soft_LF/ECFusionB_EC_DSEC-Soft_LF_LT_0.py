...
assert fusion_module['GSTFM'] + fusion_module['CC'] + fusion_module['EF'] + fusion_module['LF'] \
    + fusion_module['BDC'] + fusion_module['EICA'] == 1
...
# ann_file_train = 'train/soft_ann/soft_ann_mini_train_LNE.json'
ann_file_train = 'train/soft_ann/soft_ann_train_LT.json'

# ann_file_test = 'train/soft_ann/soft_ann_mini_train_LNE.json'
