...
model = dict(
    ...
    multi_level_fusion=dict(
        ...
        group_factors_a=[16, 9, 0],
        group_factors_b=[16, 9, 0],
...
classes = ('car', 'truck', 'person', 'motorcycle', 'bicycle', 'bus')
...
ann_file_train = 'train/soft_ann/soft_ann_train_LN.json'

ann_file_test = 'train/soft_ann/soft_ann_test_LN.json'
