...
embed_dims = 256
num_bins = 5
flow=dict(only_event=True, only_color=False, fusion=False, only_heatmap=True, one_level=True)
num_queries = 20
...
model = dict(
    ...
    heatmap_head=dict(
        ...
        feat_channels=128,
        train_cfg=None,
        # this topk only be used when only_heatmap is True for EC_CenterNetHead
