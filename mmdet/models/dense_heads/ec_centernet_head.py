...
from mmdet.models.utils.misc import samplelist_boxtype2tensor, unpack_gt_instances
...
class EC_CenterNetHead(BaseDenseHead):
    """changed from Objects as Points Head.
