...
class EC_PackDetInputs(BaseTransform):
    ...
    def permute_contigouous(self, img):
    ...
    def transform(self, results: dict) -> dict:
        ...
        if self.only_event:
            if 'img' in results:
                ...
                img = self.permute_contigouous(img)
            ...
            if 'c_img' in results:
                ...
                c_img = self.permute_contigouous(c_img)

            packed_results['inputs'] = img
            packed_results['c_inputs'] = c_img

            self.meta_keys.append('c_img_path')
